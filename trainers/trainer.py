...
class cross_domain_trainer(object):
   ...
   This class contain the main training functions for our AdAtime
    ...
    def train(self):
        ...
        for i in scenarios:
            ...
            if  self.da_method == 'RAINCOAT':
                ...
                log = {'scenario':i,'run_id':run_id,'accuracy':acc,'f1':f1}
                df_a = df_a._append(log, ignore_index=True)

        mean_acc, std_acc, mean_f1, std_f1 = self.avg_result(df_a,'average_align.csv')
        log = {'scenario':'Avg Accuracy: ' + str(mean_acc),'run_id':'Accuracy STD: ' + str(std_acc),
               'accuracy':'Avg F1: ' + str(mean_f1),'f1':'F1 STD: ' + str(std_f1)}
    ...
    def avg_result(self, df, name):
        ...
        return mean_acc['accuracy'].mean(), std_acc['accuracy'].std(), mean_f1['f1'].mean(), std_f1['f1'].std()
